...
const ITEMS: SectionItem[] = [
  { num: '01', tag: 'START HERE · SIMPLE MODE', size: 'hs-wide', title: 'Not sure what you’re looking at? Just ask.',
    body: 'The Swarm Agent panel is your control point. Type a question in plain language — “what are you doing right now?”, “why did you skip that trade?” — and it explains the whole dashboard for you. If you only use one thing, use this.' },
  ...
  { num: '03', tag: 'EXECUTION PIPELINE', size: 'hs-med', title: 'Watch it think, live',
    body: 'The Execution panel shows each decision moving through its 24 stages, from reading the market to logging on-chain. It is the real-time view of the process — nothing happens off-screen.' },
